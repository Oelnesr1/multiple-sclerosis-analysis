...
lst1 = [{"c", "a"}, "b", "d"]
lst2 = ["a", {"c", "b"}, "d"]
ans_rbo = _round(rbo(lst1, lst2, p=.5))
print(ans_rbo)

OpenTargets = open("/Users/omarelnesr/MS-Project/Open_Targets_Symbols.tsv", "r")
OpenTargetsSymbols = OpenTargets.read().split("\n")
OpenTargets.close()

NAWM = open("/Users/omarelnesr/MS-Project/RA_FGSEA/NAWM.rGEO.symbols.tsv", "r")
NAWMSymbols = NAWM.read().split("\n")
print(NAWMSymbols)
NAWM.close()

ans_rbo = _round(rbo(OpenTargetsSymbols, NAWMSymbols, p=.9))
print(ans_rbo)
